...
**Hook:** 
"I audited 50 top experts in ChatGPT. 90% of them are invisible to AI. 
Traditional SEO is dying. Welcome to the era of AEO (AI Engine Optimization).
Here is how I built a site that ИИ-агенты love, and how you can scan yours for free."
...
## 2. Direct Outreach (DM Script)
**Target:** High-ticket experts with old sites.
**Script:**
...
## 4. Distribution Channels (Free)
- **Reddit:** /r/marketing, /r/solopreneur (Focus on the tech stack).
- **VC Communities:** Showcase as a premium service for portfolio founders.
- **Telegram:** Expert groups (Share the "AI Visibility Score" screenshot).
